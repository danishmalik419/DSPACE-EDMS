                ...
                results.map((result) => (
                  ...
                  >
                    <div className="w-32 p-4 flex items-center justify-center">
                      <div className="w-24 h-32 bg-gray-100 border border-gray-300"></div>
                    </div>
            ...
            <div className="flex justify-center mt-6">
              <div className="flex items-center">
                <button
                  ...
                  className="w-8 h-8 flex items-center justify-center bg-gray-100 border border-gray-300"
                  disabled={page === 0}
                >
                  <svg
                    className="w-4 h-4"
                ...
                <span className="w-8 h-8 flex items-center justify-center mx-1 bg-orange-500 text-white border border-orange-500 text-sm">
                  {page + 1}
                </span>
                <button
                  onClick={() => setPage((prev) => prev + 1)}
                  className="w-8 h-8 flex items-center justify-center mx-1 border border-gray-300 text-sm cursor-pointer"
