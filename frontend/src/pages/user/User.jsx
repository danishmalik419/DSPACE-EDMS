  ...
  useEffect(() => {
    ...
    const fetchUsers = async () => {
      try {
        ...
        const url = `${API_URL}/librarian/user/all?page=${page}&size=${size}&query=${encodeURIComponent(appliedSearchQuery)}&isArchived=false`;
    ...
    <>
      ...
      <div className="font-sans max-w-6xl mx-auto px-4">
        ...
        <div className="flex justify-between items-center mb-5">
          ...
          <button 
            className="bg-white border border-orange-500 text-orange-500 px-4 py-2 rounded flex items-center hover:bg-orange-50" 
            onClick={() => navigate("/createUser")}
          >
            <span className="mr-1 text-base">+</span> Add E person
          </button>
        </div>
